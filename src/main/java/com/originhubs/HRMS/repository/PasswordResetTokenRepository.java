...
public interface PasswordResetTokenRepository extends JpaRepository<PasswordResetToken, Long> {
    ...
    void markAllUserTokensAsUsed(@Param("user") User user, @Param("usedAt") LocalDateTime usedAt);
    
    @Modifying
    @Transactional
    @Query("DELETE FROM PasswordResetToken t WHERE t.expiryDate < :cutoffDate")
